...
///
/// Ported from Glance (`Settings/SettingsTabBar.swift`, MIT © Jonathan Zhou).
/// The only adaptation is `SettingsTab.visibleTabs`: Glance appends a
/// debug-only Face Lab tab when it has been revealed, while this app's tab
/// list is fixed.
